        ...
        <div id="home">
            ...
            <div id="home-media-holder" >
                <ul id="home-media-list">
                    ...
                    <li ><a id="pinterrest" className="home-media" href="/"><img src={pinterest} alt="pinterest" /> </a></li>
                    <li ><a id="pinterest" className="home-media" href="/"><img src={twitter} alt="twitter" /> </a></li>
                </ul>
            </div>
